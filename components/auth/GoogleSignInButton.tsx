...
export function GoogleSignInButton() {
  ...
  return (
    <TactileButton
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-[#2D2D2D] text-[#E4E3E0] hover:bg-[#1A1A1A] transition-colors shadow-md border border-white/10"
    >
      {loading ? (
